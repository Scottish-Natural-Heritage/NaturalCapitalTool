...
#' @return A raster with raw demand scores (arbitrary units).
#' @export
#'
demand_access_scot <- function(x = parent.frame()$mm,
   ...
   # Rescale all indicators on 0-1 scales to sum in final step
   
   # angst is already a 0-1 scale
   
   #popscore2 <- rescale_score(popscore, minval=pop_threshold, score_type = "pop")
